...
<template>
  <div class="card-works shadow-lg p-3 mb-5 bg-body-tertiary rounded mt-3">
    <div class="d-flex justify-content-between">
      ...
      <button class="btn-delete pt-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
    ...
    <p class="color-darkblue amount-work mb-2">{{cost}}</p>
